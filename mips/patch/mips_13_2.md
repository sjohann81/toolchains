...
(define_expand "mul<mode>3"
  ...
  "(ISA_HAS_<D>MULT || ISA_HAS_R6<D>MUL) && !ISA_MIPS1"
{
  rtx lo;
...
(define_insn "mul<mode>3_internal"
  [(set (match_operand:GPR 0 "muldiv_target_operand" "=l")
	(mult:GPR (match_operand:GPR 1 "register_operand" "d")
		  (match_operand:GPR 2 "register_operand" "d")))]
  "ISA_HAS_<D>MULT && !TARGET_FIX_R4000 && !ISA_MIPS1"
  "<d>mult\t%1,%2"
  [(set_attr "type" "imul")
   (set_attr "mode" "<MODE>")])
...
(define_expand "<u>mulsidi3"
  ...
  "mips_mulsidi3_gen_fn (<CODE>) != NULL && !ISA_MIPS1"
{
...
(define_insn "<u>mulsidi3_32bit"
  ...
  "!TARGET_64BIT && (!TARGET_FIX_R4000 || ISA_HAS_DSP) && ISA_HAS_MULT && !ISA_MIPS1"
{
  if (ISA_HAS_DSP_MULT)
...
(define_insn_and_split "<su>mulsi3_highpart_internal"
  ...
  "ISA_HAS_MULT && !ISA_HAS_MULHI && !TARGET_MIPS16 && !ISA_MIPS1"
  { return TARGET_FIX_R4000 ? "mult<u>\t%1,%2\n\tmfhi\t%0" : "#"; }
  "&& reload_completed && !TARGET_FIX_R4000 && !ISA_MIPS1"
  [(const_int 0)]
{
  emit_insn (gen_<su>mulsi3_highpart_split (operands[0], operands[1],
					    operands[2]));
  ...
  [(parallel
     [(set (match_operand:GPR 0 "register_operand")
      ...
      (set (match_operand:GPR 3 "register_operand")
	   (mod:GPR (match_dup 1)
		    (match_dup 2)))])]
  "ISA_HAS_<D>DIV && !TARGET_FIX_VR4120 && !ISA_MIPS1"
{
  if (TARGET_MIPS16)
    {
...
(define_insn_and_split "*divmod<mode>4"
  [(set (match_operand:GPR 0 "register_operand" "=l")
   ...
   (set (match_operand:GPR 3 "register_operand" "=d")
	(mod:GPR (match_dup 1)
		 (match_dup 2)))]
  "ISA_HAS_<D>DIV && !TARGET_FIX_VR4120 && !TARGET_MIPS16 && !ISA_MIPS1"
  "#"
  "&& reload_completed"
  [(const_int 0)]
{
...
(define_insn_and_split "*udivmod<mode>4"
  [(set (match_operand:GPR 0 "register_operand" "=l")
   ...
   (set (match_operand:GPR 3 "register_operand" "=d")
	(umod:GPR (match_dup 1)
		  (match_dup 2)))]
  "ISA_HAS_<D>DIV && !TARGET_MIPS16 && !ISA_MIPS1"
  "#"
  "reload_completed"
  [(const_int 0)]
{
...
(define_insn "mov_<load>l"
  [(set (match_operand:GPR 0 "register_operand" "=d")
	(unspec:GPR [(match_operand:BLK 1 "memory_operand" "m")
		    ...
		    UNSPEC_LOAD_LEFT))]
  "!TARGET_MIPS16 && !ISA_MIPS1 && mips_mem_fits_mode_p (<MODE>mode, operands[1])"
  "<load>l\t%0,%2"
  [(set_attr "move_type" "load")
   (set_attr "mode" "<MODE>")])
...
(define_insn "mov_<store>l"
  [(set (match_operand:BLK 0 "memory_operand" "=m")
	(unspec:BLK [(match_operand:GPR 1 "reg_or_0_operand" "dJ")
		     (match_operand:QI 2 "memory_operand" "ZC")]
		    UNSPEC_STORE_LEFT))]
  "!TARGET_MIPS16 && !ISA_MIPS1 && mips_mem_fits_mode_p (<MODE>mode, operands[0])"
  "<store>l\t%z1,%2"
